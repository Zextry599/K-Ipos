      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            ->first();
            @endphp
            @if($access->kelola_user == 1)
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#kelola_user" aria-expanded="false" aria-controls="kelola_user">
              ...
              <div class="collapse" id="kelola_user">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{ url('/mitra') }}">Mitra</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            @if(\App\Models\Supply_system::first()->status == true)
            <li class="nav-item">
        ...
        <div class="main-panel">
          ...
          <footer class="footer" id="footer-content">
            <div class="container-fluid clearfix">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright 2025 All rights reserved.</span>
